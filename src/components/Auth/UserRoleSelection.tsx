      ...
      <div className=" grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 max-w-4xl mx-auto w-full">
        ...
        >
          ...
          <div className="space-y-6 relative z-10">
            ...
            <div className="space-y-2">
              <h3 className="text-xl md:text-3xl font-black text-white tracking-tight uppercase font-display leading-none">CREATOR / INFLUENCER</h3>
        ...
        >
          ...
          <div className="space-y-6 relative z-10">
            ...
            <div className="space-y-2">
              <h3 className="text-xl md:text-3xl font-black text-white tracking-tight uppercase font-display leading-none">BRAND / BUSINESS</h3>
