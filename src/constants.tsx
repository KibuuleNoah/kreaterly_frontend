...
export const MOCK_CAMPAIGNS: Campaign[] = [
  {
    ...
    brandLogo: 'https://images.unsplash.com/photo-1614680376593-902f74cf0d41?auto=format&fit=crop&q=80&w=100&h=100',
    ...
    description: 'Create short-form clips using the official Call of Duty assets provided to promote Season 02.',
    requirementsText: 'Refer to the Google Doc for the requirements!',
    platformPayouts: [
      { platform: Platform.TIKTOK, rate: '$1.00 / 1,000 views', minPayout: '$1.00', maxPayout: '$450.00' },
      { platform: Platform.INSTAGRAM, rate: '$1.00 / 1,000 views', minPayout: '$1.00', maxPayout: '$450.00' }
    ],
    faqs: [
      { question: 'Is this legit?', answer: 'Yes! This is backed by the official CoD team Activision.' },
      { question: 'Where are the requirements?', answer: 'The requirements are located in the Google Doc, it is on this page!' }
    ],
    topVideos: [
      {
        id: 'v1',
        ...
        creatorAvatar: 'https://images.unsplash.com/photo-1531427186611-ecfd6d936c79?auto=format&fit=crop&w=100'
      },
      {
        id: 'v2',
        ...
        creatorAvatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=100'
      }
    ],
  ...
  },
  {
    ...
    description: 'Document your Airtel 5G speed test experience in different parts of Kampala.',
    requirementsText: 'Show the speed test result clearly and mention "The Unstoppable Network".',
    platformPayouts: [
      { platform: Platform.TIKTOK, rate: '$2.30 / 1,000 views', minPayout: '$10.00', maxPayout: '$2000.00' }
    ],
    faqs: [],
    topVideos: [],
  ...
  },
  {
    ...
    brandLogo: 'https://images.unsplash.com/photo-1470225620780-dba8ba36b745?auto=format&fit=crop&q=80&w=100&h=100',
    ...
    isVerified: true,
    platforms: [Platform.TIKTOK, Platform.INSTAGRAM],
    description: 'Show Marcus Mumford as a brilliant storyteller and emotional live performer.',
    requirementsText: 'Refer to our campaign guidelines for clipping performance clips.',
    platformPayouts: [
      { platform: Platform.TIKTOK, rate: '$3.00 / 1,000 views', minPayout: '$5.00', maxPayout: '$1000.00' }
    ],
    faqs: [],
    topVideos: [],
