  ...
  return (
    <>
      <div className="flex min-h-screen bg-[#050505]">
        {!isBrandFirstTime && <RetractableSidebar links={BRAND_NAV_ITEMS} />}
        {!isBrandFirstTime && (
          <MobileNav links={BRAND_NAV_ITEMS} Ctx={BrandDashboardCtx} />
        )}
        <BrandTopBar />
