...
export enum Collections {
  ...
  Campaigns = "campaigns",
  CampaignsParticipants = "campaigns_participants",
  Creators = "creators",
...
export enum CampaignsParticipantsStatusOptions {
  "active" = "active",
  "deactive" = "deactive",
}
export type CampaignsParticipantsRecord<Tsubmissions = unknown> = {
  campaign?: RecordIdString;
  created: IsoAutoDateString;
  creator?: RecordIdString;
  id: string;
  status?: CampaignsParticipantsStatusOptions;
  submissions?: null | Tsubmissions;
  updated: IsoAutoDateString;
};

export type CreatorsRecord<
  Tcontent_gallery = unknown,
  Tinterests = unknown,
  Tstats = unknown,
> = {
  avatar?: string;
  bio?: HTMLString;
  campaigns?: RecordIdString[];
...
export type BrandsResponse<Texpand = unknown> = Required<BrandsRecord> &
  BaseSystemFields<Texpand>;
export type CampaignInvitesResponse<Texpand = unknown> =
  Required<CampaignInvitesRecord> & BaseSystemFields<Texpand>;
...
> = Required<CampaignsRecord<Tage_ranges, Tplatform_payouts, Ttop_videos>> &
  BaseSystemFields<Texpand>;
export type CampaignsParticipantsResponse<
  Tsubmissions = unknown,
  Texpand = unknown,
> = Required<CampaignsParticipantsRecord<Tsubmissions>> &
  BaseSystemFields<Texpand>;
export type CreatorsResponse<
  ...
  Tstats = unknown,
  Texpand = unknown,
> = Required<CreatorsRecord<Tcontent_gallery, Tinterests, Tstats>> &
  BaseSystemFields<Texpand>;
export type SubmissionsResponse<Texpand = unknown> =
  Required<SubmissionsRecord> & BaseSystemFields<Texpand>;
...
export type CollectionRecords = {
  ...
  campaigns_participants: CampaignsParticipantsRecord;
...
export type CollectionResponses = {
  ...
  campaigns_participants: CampaignsParticipantsResponse;
